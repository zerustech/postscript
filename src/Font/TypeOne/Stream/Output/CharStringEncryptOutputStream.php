...
/**
 * This class performs char string encryption on the plain text and writes the
 * encrypted data to the subordinate output stream.
 *
 * @author Michael Lee <michael.lee@zerustech.com>
 */
class CharStringEncryptOutputStream extends EncryptOutputStream
{
    /**
     ...
     * @param string $seeds The random bytes to be inserted, "\x00\x00\x00\x00"
     * by default.
     */
    public function __construct(OutputStreamInterface $out, $seeds = "\x00\x00\x00\x00")
    {
        parent::__construct($out, 4330, $seeds);
    }
}
